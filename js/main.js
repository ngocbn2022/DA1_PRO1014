(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Xử lý sự kiện khi người dùng chọn rate
        $('input[name="rate"]').on('change', function () {
            var selectedRate = $('input[name="rate"]:checked').val();
            // Gán giá trị vào trường input có id="selectedRate"
...
function cofirmcapquyen() {
    return confirm("Bạn có chắc chắn cấp quyền người này không ?");
};

function cofirmhaquyen() {
    return confirm("Bạn có chắc chắn hạ quyền người này không ?");
};

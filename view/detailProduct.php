            ...
            <div class="h-100 bg-light p-30">
                    ...
                    <form class="ps-1">
                        ...
                        ?>
                            <div class="custom-control custom-radio custom-control-inline ">
                                <input type="radio" class="custom-control-input" id="size-1" name="size" value="<?= $size_id ?>">
                ...
                <div class="d-flex mb-4">
                    ...
                    <form class="ps-1">
                        ...
                        ?>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="color-1" name="color" value="<?= $color_id ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <?php if (isset($_SESSION['user_name']) && $_SESSION['user_name'] != "") { ?>
                                    ...
                                    <form method="post" action="index.php?act=detailProduct&product_id=<?= $product_id ?>">
